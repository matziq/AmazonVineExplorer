...
document.head.innerHTML = `
    ...
    <style>
        ...
        h1 {
            margin-top: 0; /* Remove top margin of heading */
        }

        #outputTextarea {
            width: calc(100% - 20px); /* 100% width minus 20px (10px on each side) for the border */
            height: 200px; /* Fixed height for console-look text field */
            background-color: #000; /* Black background */
            color: #00ff00; /* Bright green text color */
            outline: none; /* No focus border */
            padding: 10px; /* Internal padding for text */
            margin-top: 10px; /* Top margin for the textarea */
            resize: none; /* Disable resizing by user */
            overflow: auto; /* Enable scrolling when text exceeds height */
        }

        #inputField {
            width: calc(100% - 20px); /* 100% width minus 20px (10px on each side) for the border */
            margin-top: 10px; /* Top margin for input field */
            padding: 10px; /* Internal padding for input field */
        }
    </style>
`;
